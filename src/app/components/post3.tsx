...
export default  function post3({ type }: { type?: "status" | "comment" }) {
        ...
        <div className='p-4 border-y-[1px] border-borderGray'>
            ...
            <div className={`flex gap-4 ${type === "status" && "flex-col"}`}>
                ...
                <div className={`${type === "status" && "hidden"
                    ...
                    <Image src={"/general/avatarnext.jpg"} alt="devwithalireza" width={100} height={100}  />
                </div>
                {/* محتوا */}
                <div className='flex-1 flex flex-col gap-2'>
                    ...
                    <div className="w-full flex justify-between">
                        <Link href={`/devrgt`} className="flex gap-4">
                            ...
                            <div className={`flex items-center gap-2 flex-wrap ${type === "status" && "flex-col gap-0 !items-start"
                                ...
                                <h2 className='font-bold text-md'>NEXT JS</h2>
                                <span
                                    className={`text-textGray text-right direction-ltr ${type === "status" ? "text-sm" : ""}`}>@next-js</span>
                                {type !== "status" && (
                    ...
                    {/* متن پست و رسانه */}
                        ...
                        <p className={`${type === "status" && "text-lg"}`}>
                            ...
                            است، چاپگرها و متو گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم
                    ...
                    <Image src="/general/post3.jpg" alt="" width={600} height={600} />
